...
<head>
    ...
    <title>SIMAP — 419 Sesi Kedaluwarsa</title>
    <script>
        (function() {
    ...
    <main class="flex-1 flex items-center justify-center px-4 py-16">
        <div class="text-center max-w-md w-full">
            ...
            <div class="flex justify-center mb-6">
                <div class="w-20 h-20 rounded-2xl bg-yellow-500/10 border border-yellow-500/20 flex items-center justify-center">
            ...
            {-- Code --}
            <p class="font-display text-8xl text-yellow-400 leading-none mb-2">419</p>

            {-- Title --}
            <h1 class="text-xl font-semibold dark:text-gray-100 text-gray-800 mb-3">Sesi Kedaluwarsa</h1>

            {-- Desc --}
            <p class="text-sm dark:text-gray-400 text-gray-500 leading-relaxed mb-8">Sesi kamu telah habis. Silakan muat ulang halaman dan coba lagi.</p>
