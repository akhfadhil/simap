...
<head>
    ...
    <title>SIMAP — 500 Kesalahan Server</title>
    <script>
        (function() {
...
<body class="dark:bg-gray-950 bg-slate-100 dark:text-gray-100 text-gray-800 min-h-screen flex flex-col">
    ...
    <main class="flex-1 flex items-center justify-center px-4 py-16">
        <div class="text-center max-w-md w-full">
            ...
            {-- Code --}
            <p class="font-display text-8xl text-red-500 leading-none mb-2">500</p>

            {-- Title --}
            <h1 class="text-xl font-semibold dark:text-gray-100 text-gray-800 mb-3">Kesalahan Server</h1>

            {-- Desc --}
            <p class="text-sm dark:text-gray-400 text-gray-500 leading-relaxed mb-8">Terjadi kesalahan pada server. Tim kami sedang menangani masalah ini.</p>
